...
export const Scene3 : React.FC<{
  ...
  const upAnimation = spring({
   ...
   const textOpacity = (() => {
     if (frame < UPSTART) {
    		return interpolate(upAnimation, [0.9, 1], [1, 0]);
     }
  ...
  return (
	...
	>
		<AbsoluteFill style={{ transform: `translateY(${contentTranslation}px)`}}>
			...
			<Title style={{ top: 1030, fontSize:20, opacity: artistTextOpacity}}>
        ...
        opacity: bottomTextOpacity,
			...
			>
				Your top song of the year is All I Talk Is Money{topSongName}.
			</ Title>
